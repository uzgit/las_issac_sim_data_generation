...
with open('history.txt', 'w') as outfile:
    print(f'{model_history.history["loss"]=},{model_history.history["accuracy"]=},{model_history.history["val_loss"]=},{model_history.history["val_accuracy"]=},epochs={len(model_history.history["val_accuracy"])}', file=outfile)